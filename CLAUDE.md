...
backend/
  ...
  ├── rob_tools/
  │   ├── rob2.py       — RoB 2 (RCTs)
  │   └── robins_i.py   — ROBINS-I V2 (20 Nov 2025 cribsheet, follow-up cohort studies; also dispatched for case-control / cross-sectional as approximation)
