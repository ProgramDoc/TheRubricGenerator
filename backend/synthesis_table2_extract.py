...
pure-Python core in ``synthesis_table2.py``.
...
place a model is touched; all derivation lives in ``synthesis_table2.py``.
"""
...
from backend.synthesis_table2 import assemble_table2, merge_injected_and_extracted
